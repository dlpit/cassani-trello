...
export const notificationsSlice = createSlice({
  ...
  reducers: {
    // Xóa toàn bộ currentNotifications trong redux
    clearCurrentNotifications: (state) => {
      state.currentNotifications = null
    },
    // Cập nhật lại toàn bộ currentNotifications trong redux
    updateCurrentNotifications: (state, action) => {
      state.currentNotifications = action.payload
    },
    // Thêm mới một cái bản ghi notification vào đầu mảng currentNotifications trong redux
