  ...
  return (
    <Box sx={{
      ...
      maxHeight: (theme) => `calc(
        ...
        ${theme.spacing(5)} -
        ${(theme) => theme.casani.columnHeaderHeight} -
        ${(theme) => theme.casani.columFooterHeight}
      )`,
      ...
      <Card sx={{
        ...
        <CardActions sx={{ p: '0 4px 8px 4px' }}>
          <Button
            ...
            size="small" startIcon={<GroupIcon />}>12</Button>
          <Button
            sx={{
              color: (theme) => theme.palette.button.primary
            }}
            size="small" startIcon={<CommentIcon />}>14</Button>
          <Button
            sx={{
              color: (theme) => theme.palette.button.primary
            }}
            size="small" startIcon={<AttachmentIcon />}>16</Button>
        </CardActions>
      </Card>
